  ...
  return (
    <div className="card">
      <div className="card-header">
        <h5 className="card-title">QR Check In</h5>
      </div>
      <div className="card-body">        
        <form action={FrontendRoutes.QRCheckIn} method="post">
          <div className="form-group">
            <label htmlFor="id_pengunjung_checkin">ID Pengunjung</label>
            <input type="text" name="id_pengunjung" id="id_pengunjung_checkin" className="form-control"/>
          </div>

          <div className="form-group">
            <label htmlFor="id_ruangan_checkin">ID Ruangan</label>
            <input type="text" name="id_ruangan" id="id_ruangan_checkin" className="form-control"/>
          </div>
